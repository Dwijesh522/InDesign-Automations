        ...
        {
                //alert("page no is :-  " + i);
                //alert("no of graplhics is:- " + myDocument.pages[i].allGraphics.length );
                //alert("no of tfs is :- " + myDocument.pages[i].textFrames.length );
                //want to iterate on all graphics
                for(j=0 ; j< myDocument.pages[i].allGraphics.length ; j++)
                {
                        //alert("graphics no is :-  "+j);
                        var inner_tf = [];
                        m=0;
                        // want to check each and every textframe for each graphics
                        for(k=0;k< myDocument.pages[i].textFrames.length ; k++)
                        {
                                //alert("textFrame no" + k);
                                //alert("coor of gr and tf are  " + yg1+"  "  + xg1+"  "  + yg2+"  "  + xg2+"\n" + yt1+"  "+  xt1+"  "+ yt2+"  "+ xt2);
                                ...
                                {
                                        //alert("this textframe is inside the graphics frame");
                                        inner_tf.push([]);
